...
Strategy1 <- function(n, simulations_df,
  ...
  full_data$inflBZ_Y1_phase1 <- inf_fun_logit(fitY1_phase1)[,"Z_obs"]
  full_data$inflBZ_Y2_phase1 <- inf_fun_logit(fitY2_phase1)[,"Z_obs"]
  ...
  infcalY1 <- survey::calibrate(mydesign, formula = ~inflB11_phase1 +
                                  ...
                                  inflB22_phase1 + inflBZ_Y1_phase1 + inflBZ_Y2_phase1 + strata, phase = 2, calfun = "raking")
...
Strategy2 <- function(n, simulations_df, scenario, N = 10000){
  ...
  calibrated_twophase_Y1_wave1 <- calibrate(twophase_design_Y1,
                                            ~ inflB11_phase1 +
                                              inflB21_phase1 +
                                              inflB12_phase1 +
                                              inflB22_phase1 + inflBZ_Y1_phase1 + inflBZ_Y2_phase1 +
                                              strata,
                                            phase = 2,
                                            calfun = "raking")
  ...
  resid_model_B11_wave1 <- lm(inflB11 ~ inflB11_phase1 +
                              inflB21_phase1 +
                              inflB12_phase1 +
                              inflB22_phase1 + inflBZ_Y1_phase1 + inflBZ_Y2_phase1 + strata,
                              data = phase2_wave1,
                              weights = phase2_weight,
                              na.action = na.exclude)
  resid_model_B21_wave1 <- lm(inflB21 ~ inflB11_phase1 +
                              inflB21_phase1 +
                              inflB12_phase1 +
                              inflB22_phase1 + inflBZ_Y1_phase1 + inflBZ_Y2_phase1 + strata,
                              data = phase2_wave1,
  ...
  resid_model_B12_wave1 <- lm(inflB12 ~ inflB11_phase1 +
                              ...
                              weights = phase2_weight,
                              na.action = na.exclude)
  resid_model_B22_wave1 <- lm(inflB22 ~ inflB11_phase1 +
                              inflB21_phase1 +
                              inflB12_phase1 +
                              inflB22_phase1 + inflBZ_Y1_phase1 + inflBZ_Y2_phase1 + strata,
                              data = phase2_wave1,
  ...
  resid_model_B11_wave2 <- lm(inflB11 ~ inflB11_phase1 +
                              ...
                              weights = phase2_weight,
                              na.action = na.exclude)
  resid_model_B21_wave2 <- lm(inflB21 ~ inflB11_phase1 +
                              inflB21_phase1 +
                              inflB12_phase1 +
                              inflB22_phase1 + inflBZ_Y1_phase1 + inflBZ_Y2_phase1 + strata,
                              data = phase2_wave2,
  ...
  resid_model_B12_wave2 <- lm(inflB12 ~ inflB11_phase1 +
                              ...
                              weights = phase2_weight,
                              na.action = na.exclude)
  resid_model_B22_wave2 <- lm(inflB22 ~ inflB11_phase1 +
                              inflB21_phase1 +
                              inflB12_phase1 +
                              inflB22_phase1 + inflBZ_Y1_phase1 + inflBZ_Y2_phase1 + strata,
                              data = phase2_wave2,
  ...
  resid_model_B11_wave3 <- lm(inflB11 ~ inflB11_phase1 +
                              ...
                              weights = phase2_weight,
                              na.action = na.exclude)
  resid_model_B21_wave3 <- lm(inflB21 ~ inflB11_phase1 +
                              inflB21_phase1 +
                              inflB12_phase1 +
                              inflB22_phase1 + inflBZ_Y1_phase1 + inflBZ_Y2_phase1 + strata,
                              data = phase2_wave3,
  ...
  resid_model_B12_wave3 <- lm(inflB12 ~ inflB11_phase1 +
                              ...
                              weights = phase2_weight,
                              na.action = na.exclude)
  resid_model_B22_wave3 <- lm(inflB22 ~ inflB11_phase1 +
                              inflB21_phase1 +
                              inflB12_phase1 +
                              inflB22_phase1 + inflBZ_Y1_phase1 + inflBZ_Y2_phase1 + strata,
                              data = phase2_wave3,
...
Strategy5 <- function(n, simulations_df, scenario, N = 10000){
  ...
  allocation <- optimum_allocation(data,
                                           strata = "strata",
                                           nsample = n,
                                           y = c("infl_B11_true", "infl_B12_true",
