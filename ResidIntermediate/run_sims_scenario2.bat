...
for %%S in (1 2 3 4) do (
   ...
   echo Running sim = %%S
   "C:\Program Files\R\R-4.2.2\bin\x64\Rscript.exe" run_simulations_scenario2.R --scenario %%S --pathname %cd%\rout\files --n !phase2size! --N !phase1size! 1>!this_outfile! 2>&1
  )
)
