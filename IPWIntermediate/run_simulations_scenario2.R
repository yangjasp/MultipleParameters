...
MSE_BX1_strat1_GR <- mean((B_hat_X1_strat1_GR - BX1_std_strat1)^2)
MSE_BX2_strat1_GR <- mean((B_hat_X2_strat1_GR - BX2_std_strat1)^2)
...
MSE_BX1_strat1_IPW <- mean((B_hat_X1_strat1_IPW - BX1_std_strat1)^2)
MSE_BX2_strat1_IPW <- mean((B_hat_X2_strat1_IPW - BX2_std_strat1)^2)
...
MSE_BX1_strat2_GR <- mean((B_hat_X1_strat2_GR - BX1_std_strat2)^2)
MSE_BX2_strat2_GR <- mean((B_hat_X2_strat2_GR - BX2_std_strat2)^2)
...
MSE_BX1_strat2_IPW <- mean((B_hat_X1_strat2_IPW - BX1_std_strat2)^2)
MSE_BX2_strat2_IPW <- mean((B_hat_X2_strat2_IPW - BX2_std_strat2)^2)
...
MSE_BX1_strat3_GR <- mean((B_hat_X1_strat3_GR - BX1_std_strat3)^2)
MSE_BX2_strat3_GR <- mean((B_hat_X2_strat3_GR - BX2_std_strat3)^2)
...
MSE_BX1_strat3_IPW <- mean((B_hat_X1_strat3_IPW - BX1_std_strat3)^2)
MSE_BX2_strat3_IPW <- mean((B_hat_X2_strat3_IPW - BX2_std_strat3)^2)
...
MSE_BX1_strat3.5_GR <- mean((B_hat_X1_strat3.5_GR - BX1_std_strat3.5)^2)
MSE_BX2_strat3.5_GR <- mean((B_hat_X2_strat3.5_GR - BX2_std_strat3.5)^2)
...
MSE_BX1_strat3.5_IPW <- mean((B_hat_X1_strat3.5_IPW - BX1_std_strat3.5)^2)
MSE_BX2_strat3.5_IPW <- mean((B_hat_X2_strat3.5_IPW - BX2_std_strat3.5)^2)
...
MSE_BX1_strat4_GR <- mean((B_hat_X1_strat4_GR - BX1_std_strat4)^2)
MSE_BX2_strat4_GR <- mean((B_hat_X2_strat4_GR - BX2_std_strat4)^2)
...
MSE_BX1_strat4_IPW <- mean((B_hat_X1_strat4_IPW - BX1_std_strat4)^2)
MSE_BX2_strat4_IPW <- mean((B_hat_X2_strat4_IPW - BX2_std_strat4)^2)
...
MSE_BX1_strat5_GR <- mean((B_hat_X1_strat5_GR - BX1_std_strat5)^2)
MSE_BX2_strat5_GR <- mean((B_hat_X2_strat5_GR - BX1_std_strat5)^2)
...
MSE_BX1_strat5_IPW <- mean((B_hat_X1_strat5_IPW - BX1_std_strat5)^2)
MSE_BX2_strat5_IPW <- mean((B_hat_X2_strat5_IPW - BX2_std_strat5)^2)
